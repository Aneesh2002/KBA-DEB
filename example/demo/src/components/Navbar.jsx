...
// import kbaima from '../assets/images'
...
const Navbar = () => {
  return (
    ...
    <div className='flex justify-center md:justify-end items-center mt-2 md:mt-0 space-x-5 md:space-x-10'>
        ...
        {/* // <a to="/coursespage" className='ml-20'>Courses</a>
        // <a to="/contact" className='ml-20'>Contact Us</a>
        // <a to="/Addcourse" className='ml-20'>Add Course</a>
        // <a to="/Updatecourse" className='ml-20'>Update Course</a> */}
    </div>
</div>
  )
}
